...
# Cambia la URL según cómo levantes el servicio (docker-compose/etc)
...
def llm_chat(prompt):
    ...
    # IMPORTANTE: enviamos la lista directa (no dentro de otra llave)
    response = requests.post(LLM_URL, json=messages)
